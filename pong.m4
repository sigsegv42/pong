# additional m4 rules
# config.nice support lifted from Apache APR (PONG_EXPAND_VAR & PONG_CONFIG_NICE)
#
...
dnl PONG_CONFIG_NICE(filename)
dnl
dnl Saves a snapshot of the configure command-line for later reuse
dnl
AC_DEFUN([PONG_CONFIG_NICE],[
  rm -f $1
  cat >$1<<EOF
#! /bin/sh
#
